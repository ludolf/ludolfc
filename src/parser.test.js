...
test('parse expression number biop with newlines', () => {
  const ast = parser.parse('1 +\n2')
  expect(ast.statements).toHaveLength(1)
  expect(ast.statements[0].isExpression).toBe(true)
  expect(ast.statements[0].parts).toHaveLength(3)
...
test('parse expression number biop with newlines #2', () => {
  const ast = parser.parse('1 +\n2 - 3')
  expect(ast.statements).toHaveLength(1)
  expect(ast.statements[0].isExpression).toBe(true)
  expect(ast.statements[0].parts).toHaveLength(5)
...
test('parse expression number biop with newlines #3', () => {
  const ast = parser.parse('1 > \n 2')
  expect(ast.statements).toHaveLength(1)
  expect(ast.statements[0].isExpression).toBe(true)
  expect(ast.statements[0].parts).toHaveLength(3)
...
test('parse expression number biop with newlines #4', () => {
  const ast = parser.parse('1 >=\n2')
  expect(ast.statements).toHaveLength(1)
  expect(ast.statements[0].isExpression).toBe(true)
  expect(ast.statements[0].parts).toHaveLength(3)
...
test('parse expression number biop with newlines #5', () => {
  const ast = parser.parse('1 + 2 -\n 3')
  expect(ast.statements).toHaveLength(1)
  expect(ast.statements[0].isExpression).toBe(true)
  expect(ast.statements[0].parts).toHaveLength(5)
...
test('parse statement while condition on newline', () => {
  const ast = parser.parse('while 1 <\n2 {}')
  expect(ast.statements).toHaveLength(1)
  expect(ast.statements[0].isWhile).toBe(true)
  expect(ast.statements[0].condition.isExpression).toBe(true)
  expect(ast.statements[0].condition.parts).toHaveLength(3)
...
test('parse statement while condition on newline #2', () => {
  const ast = parser.parse('while 1 < \n 2 {}')
  expect(ast.statements).toHaveLength(1)
  expect(ast.statements[0].isWhile).toBe(true)
  expect(ast.statements[0].condition.isExpression).toBe(true)
...
test('parse statement while condition on newline #3', () => {
  const ast = parser.parse('while Ludolf.position.x != x |\nLudolf.position.y != y {}')
  expect(ast.statements).toHaveLength(1)
  expect(ast.statements[0].isWhile).toBe(true)
  expect(ast.statements[0].condition.isExpression).toBe(true)
  expect(ast.statements[0].condition.parts).toHaveLength(11)
})
...
test('parse if else condition on newline', () => {
  const ast = parser.parse('if 1 >\n2 {a} else {b}')
  expect(ast.statements).toHaveLength(1)
  expect(ast.statements[0].isIf).toBe(true)
  expect(ast.statements[0].condition.isExpression).toBe(true)
  expect(ast.statements[0].condition.parts).toHaveLength(3)
